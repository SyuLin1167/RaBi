...
public class PlayerScript : MonoBehaviour
{
    ...
    [SerializeField] private float Speed=90.0f;                         //移動速度
    ...
    void MoveControll()
    {
        x=Input.GetAxisRaw("Horizontal")*Speed;                         //左右キーが押されたときの値をX座標に入れる    
        z=Input.GetAxisRaw("Vertical")*Speed;                           //上下キーが押されたときの値をY座標に入れる
